    ...
    <nav className="bg-black h-[81px] rounded-[30px] mx-auto flex items-center justify-between px-4 fixed z-50 w-full left-0 right-0 max-w-[1140px] lg:mt-10">
      <div className="hidden lg:flex items-center text-white w-full justify-between">
        <ul className="flex items-center flex-grow justify-between">
          <li className="ml-20 group">
            <a href="/" onClick={(e) => { e.preventDefault(); navigateToLanding(); }} className="group-hover:bg-[#D92D20] group-hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Beranda</a>
          </li>
          <li className="mx-1 group">
            <a href="#biografi" onClick={(e) => handleScroll(e, 'biografi')} className="group-hover:bg-[#D92D20] group-hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Biografi</a>
          </li>
          <li className="mx-1 group">
            <a href="#publikasi" onClick={(e) => handleScroll(e, 'publikasi')} className="group-hover:bg-[#D92D20] group-hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Pojok Kandidat</a>
          </li>
          ...
          <li className="mx-1 group">
            <a href="#karier" onClick={(e) => handleScroll(e, 'karier')} className="group-hover:bg-[#D92D20] group-hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Karier</a>
          </li>
          <li className="mr-20 group">
            <a href="#berita" onClick={(e) => handleScroll(e, 'berita')} className="group-hover:bg-[#D92D20] group-hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Berita</a>
          </li>
        </ul>
      </div>
      ...
      <div className={`fixed top-0 left-0 w-full h-screen bg-black text-white flex flex-col items-center transition-transform duration-300 ${isMenuOpen ? 'translate-y-0' : 'translate-y-[-100%]'}`}>
        ...
        <ul className="mt-16 w-full flex flex-col items-center">
          <li className="py-2">
            <a href="/" onClick={(e) => { e.preventDefault(); navigateToLanding(); }} className="hover:bg-[#D92D20] hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Beranda</a>
          </li>
          <li className="py-2">
            <a href="#biografi" onClick={(e) => handleScroll(e, 'biografi')} className="hover:bg-[#D92D20] hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Biografi</a>
          </li>
          <li className="py-2">
            <a href="#publikasi" onClick={(e) => handleScroll(e, 'publikasi')} className="hover:bg-[#D92D20] hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Pojok Kandidat</a>
          </li>
          ...
          <li className="py-2">
            <a href="#karier" onClick={(e) => handleScroll(e, 'karier')} className="hover:bg-[#D92D20] hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Karier</a>
          </li>
          <li className="py-2">
            <a href="#berita" onClick={(e) => handleScroll(e, 'berita')} className="hover:bg-[#D92D20] hover:text-white px-3 py-2 rounded-[60px] transition duration-300">Berita</a>
          </li>
        </ul>
      </div>
    </nav>
