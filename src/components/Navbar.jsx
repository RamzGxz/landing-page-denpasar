...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black sticky top-5 h-[50px] rounded-xl w-full lg:max-w-screen-xl lg:mx-auto lg:h-[75px] flex items-center z-50 lg:top-5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-14 lg:max-w-full">
        <div className="hidden lg:flex items-center text-white flex-grow justify-between">
            ...
            <li className="mx-1 group relative">
              ...
              {isDropdownOpen && (
                <ul className="absolute top-full left-0 mt-2 bg-black rounded shadow-lg">
                  ...
                  <li className="px-4 py-2 hover:bg-[#D92D20]"><a href="/GedeSupritana">Gede Supriatna</a></li>
                </ul>
              )}
            </li>
            <li className="mx-1 group">
