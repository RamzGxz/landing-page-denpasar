      ...
      <>
          <div className="max-w-screen-xl mx-auto mt-14 pt-24 md:mt-16 lg:pt-24" id="biografi">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 mt-20 lg:mt-20 mx-2 lg:mx-16">
                  ...
                  <div className="relative bg-[#D92D20] w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] flex justify-center items-center rounded-full mx-auto md:mx-auto lg:ml-[70px] overflow-hidden order-1 lg:order-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 mt-32 lg:mt-28 mx-2 lg:mx-16">
                  ...
                  <div className="relative bg-[#D92D20] w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] flex justify-center items-center rounded-full mx-auto md:mx-auto lg:mx-0 overflow-hidden">
